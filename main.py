...
for i in range(num_iters):
	...
	Generator.backward_pass(learning_rate,momentum, momentum_training, generator_outputs,Discriminator.backward_pass_for_generator(generator_outputs),prior_z)
